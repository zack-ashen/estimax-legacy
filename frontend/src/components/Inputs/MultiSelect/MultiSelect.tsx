      ...
      <Select
        ...
        styles={{
          control: (provided: CSSObjectWithLabel, state: ControlProps<OptionType, true, GroupBase<OptionType>>) => ({
            ...
            borderColor: error ? '#F04438' : state.isFocused ? '#415BC6' : '#D0D5DD', // colors depending on the focus state
            ...
            '&:hover:not(:focus)': {
              borderColor: error ? '#F04438' : state.isFocused ? '#415BC6' : '#D0D5DD', // border color when hovered
            },
            '> :last-child': {
              color: '#98A2B3',
