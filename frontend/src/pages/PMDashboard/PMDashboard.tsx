  ...
  const filterProps = [
    {
      ...
      logic: (row: any[]) => row.some((cell: { filterValue: string; }) => cell.filterValue === "Regular Text 3")
    },
    {
      label: "Only Regular Text 2",
      logic: (row: any[]) => row.some((cell: { filterValue: string; }) => cell.filterValue === "Regular Text 2")
    }
    // ... other filters
  ];
